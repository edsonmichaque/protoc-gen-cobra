...
func _TypesEchoCommand(cfg *client.Config) *cobra.Command {
	...
	flag.SliceVar(cmd.PersistentFlags(), flag.ParseMessageE[*Sound_NestedMessage], &req.ListNestedMsg, cfg.FlagNamer("ListNestedMsg"), "")
	flag.SliceVar(cmd.PersistentFlags(), flag.ParseMessageE[*GlobalMessage], &req.ListGlobalMsg, cfg.FlagNamer("ListGlobalMsg"), "")
	...
	flag.MapVar(cmd.PersistentFlags(), flag.ParseStringE, flag.ParseMessageE[*Sound_NestedMessage], &req.MapStringNestedMsg, cfg.FlagNamer("MapStringNestedMsg"), "")
	flag.MapVar(cmd.PersistentFlags(), flag.ParseStringE, flag.ParseMessageE[*GlobalMessage], &req.MapStringGlobalMsg, cfg.FlagNamer("MapStringGlobalMsg"), "")
